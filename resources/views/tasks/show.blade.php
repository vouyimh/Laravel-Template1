                                                    ...
                                                    <span
                                                        class="badge fs-6 {{ $task->status == 'completed'
                                                            ...
                                                            : ($task->status == 'in_progress'
                                                                ...
                                                                : 'bg-secondary') }}">
                                                        <i
                                                            class="fas {{ $task->status == 'completed'
                                                                ? 'fa-check-circle'
                                                                : ($task->status == 'in_progress'
                                                                    ? 'fa-clock'
                                                                    : 'fa-hourglass-start') }} me-1"></i>
                                                    ...
                                                    <span
                                                        class="badge fs-6 {{ ($task->priority ?? 'medium') == 'high'
                                                            ...
                                                            : (($task->priority ?? 'medium') == 'medium'
                                                                ...
                                                                : 'bg-info') }}">
                                                        <i
                                                            class="fas {{ ($task->priority ?? 'medium') == 'high'
                                                                ? 'fa-arrow-up'
                                                                : (($task->priority ?? 'medium') == 'medium'
                                                                    ? 'fa-minus'
                                                                    : 'fa-arrow-down') }} me-1"></i>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @if ($task->due_date)
                                                        @php
                                                            ...
                                                            $isOverdue =
                                                                $dueDate->isPast() && $task->status !== 'completed';
                                                            $isDueSoon =
                                                                $dueDate->diffInDays(now()) <= 3 &&
                                                                $dueDate->isFuture();
                                                        @endphp
                                                        <p class="mb-1">
                                                            <span
                                                                class="badge fs-6 {{ $isOverdue ? 'bg-danger' : ($isDueSoon ? 'bg-warning' : 'bg-success') }}">
